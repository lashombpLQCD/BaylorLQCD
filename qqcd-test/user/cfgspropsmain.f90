...
!   enddo ! nhit
!-single process mode
    rwdir = "/data/whytet/qqcd/scratch1569big/" !BS
...
!    kappa(1) = 0.165_KR*tad(1)
   ...
   ! kappa(1) = 0.15700_KR2*tad(1)  !this is the value used in my original test !TW 11/17/20 uncomment here for kappa crit                                       
   kappa(1) = 0.1570_KR*tad(1)  !test value!BS  differentiate  kappa(1) & kappa
...
! MASS AVERAGING
  ...
  ! beta=6.0 
    ...
    mtmqcd(1,1:2)  =  (/ 0.1560_KR*tad(1), 0.00001_KR /)!Just for testing,other        
