...
%Here is my edit
  ...
  ntrials = 1;     % trials
 % nrhs = 2; 
  %nrhs = 200; %Commented out for testing -PL      % noises per trial % Chris changed from 200 -> 3
  ...
  numconfigs = 10;
 % polys = [7]; 
  %polys = [10,20,50,100,150,200]; % Commented out for testing -PL
  polys = [50, 100, 200]; %Using three degrees to test scaling -PL 7/29/20 
